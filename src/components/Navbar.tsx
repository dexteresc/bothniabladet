    ...
    <header className="sticky w-full h-16 bg-inherit text-gray-500 dark:text-gray-200 flex items-center border-b border-b-gray-100 dark:border-b-gray-900">
      <nav className="w-full flex items-center px-4">
          ...
          >
            <g id="Layer_2" data-name="Layer 2">
              <g id="Layer_1-2" data-name="Layer 1">
                ...
                <rect fill="#36c" x="27" y="0.23" width="43.96" height="202" />
                <path
                  fill="currentColor"
        ...
        <div className="flex items-center flex-1 justify-end lg:justify-between flex-nowrap">
          ...
          <button className="mr-0 lg:mr-2 font-semibold flex items-center p-2 lg:px-4 lg:py-2 transition-all hover:bg-gray-100 dark:hover:bg-gray-700 active:bg-blue-200 dark:active:bg-gray-500 whitespace-nowrap select-none rounded-full lg:rounded">
