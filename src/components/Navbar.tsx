...
function Navbar() {
  ...
  const handleSearch = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (searchEl.current) {
      if (!searchEl.current.value.trim()) {
        return;
      }
    ...
    if (searchEl.current) {
      navigate(`/search?q=${searchEl.current.value}`);
    }
  };

  const handleSearchClick = () => {
    if (searchEl.current && !searchActive) {
        ...
        <nav className="w-full flex items-center px-4">
          ...
          <div className="flex items-center flex-1 justify-end lg:justify-between flex-nowrap">
            <form
              ...
              className="px-2 lg:px-4 py-2 rounded-full lg:rounded flex items-center lg:flex-grow-0 lg:flex-shrink lg:basis-[50vw] lg:max-w-[720px] hover:transition-colors transition-transform lg:bg-gray-100 dark:lg:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 active:bg-gray-200 dark:active:bg-gray-600 lg:active:bg-gray-100 dark:lg:active:bg-gray-700 lg:hover:bg-gray-100 dark:lg:hover:bg-gray-700 focus-within:bg-white dark:focus-within:bg-gray-600 focus-within:drop-shadow lg:focus-within:active:bg-white dark:focus-within:active:bg-gray-600 lg:focus-within:hover:bg-white  dark:lg:focus-within:hover:bg-gray-600"
            >
              <span
                role="img"
